...
wasm:
  ...
  RUN ARCH=$(uname -m) && \
      wget -q https://github.com/bytecodealliance/wasmtime/releases/download/v40.0.1/wasmtime-v40.0.1-${ARCH}-linux.tar.xz && \
      tar -xf wasmtime-v40.0.1-${ARCH}-linux.tar.xz && \
      mv wasmtime-v40.0.1-${ARCH}-linux/wasmtime /usr/local/bin/ && \
      rm -rf wasmtime-v40.0.1-${ARCH}-linux*
